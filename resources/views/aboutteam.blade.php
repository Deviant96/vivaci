...
@section('content')
    <section>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div
                    class="col-12 col-md-6 order-2 order-md-1 d-flex flex-column justify-content-center px-0 px-md-5 mt-5 mt-md-0">
                    <div class="ms-0 ms-md-5 px-4 px-md-0">
                        <h2 class="fw-bold font-big-one" data-aos="fade-right">Explore our <span class="text-lowercase">{{ $details->name }}</span>
                            team at
                            {{ setting('site.title') }}</h2>
                        <div class="mt-3" data-aos="fade-left">{!! $details->description !!}</div>
                    </div>
                </div>
                        ...
                        @else
                            @foreach ($em as $e)
                                <div class="col-6 col-sm-4">
                                    <div class="img-container member-img-container img-shadow" data-aos="fade-up">
